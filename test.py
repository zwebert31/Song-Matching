...
class MyTest(unittest.TestCase):
    ...
    def getDirResult(self, dir1, dir2):
        try:
            result = subprocess.check_output(["./dan2", "-d", dir1, "-d", dir2])
            return result
        except subprocess.CalledProcessError, e:
            return e.output
    ...
    #def testA4NonMatches(self):
        #self.assertEqual(self.getResult("/course/cs4500f14/Assignments/A4/z01.wav", "/course/cs4500f14/Assignments/A4/z08.wav"), "")
        
    
    def testA6Matches(self):
        self.checkMatch("/course/cs4500f14/Assignments/A6/D3/b.wav", "/course/cs4500f14/Assignments/A6/D3/guy_in_yer_bar.wav")
